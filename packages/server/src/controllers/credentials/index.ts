...
const createCredential = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const apiResponse = await credentialsService.createCredential(req.body, req.userId!)
...
const deleteCredentials = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const apiResponse = await credentialsService.deleteCredentials(req.params.id, req.userId!)
        return res.json(apiResponse)
    } catch (error) {
        next(error)
    }
...
const getAllCredentials = async (req: Request, res: Response, next: NextFunction) => {
    try {
        const apiResponse = await credentialsService.getAllCredentials(req.query.credentialName, req.userId!)
        return res.json(apiResponse)
    } catch (error) {
        next(error)
    }
...
const getCredentialById = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const apiResponse = await credentialsService.getCredentialById(req.params.id, req.userId!)
        return res.json(apiResponse)
    } catch (error) {
        next(error)
    }
...
const updateCredential = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const apiResponse = await credentialsService.updateCredential(req.params.id, req.userId!, req.body)
        return res.json(apiResponse)
    } catch (error) {
        next(error)
    }
