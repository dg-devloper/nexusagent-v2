...
import { Avatar, Box, ButtonBase, Stack, Button } from '@mui/material'
...
const CanvasSubHeader = ({ chatflow, isAgentCanvas, handleSaveFlow, handleDeleteFlow, handleLoadFlow }) => {
        ...
        <>
            <Stack flexDirection='row' justifyContent='space-between' sx={{ position: 'absolute', right: 20, top: 20 }}>
                <Box sx={{ display: 'flex', gap: '1rem' }}>
                    ...
                    <ButtonBase ref={settingsRef} title='Settings' sx={{ borderRadius: '50%', zIndex: 200 }}>
                        <Avatar
                            variant='rounded'
                            sx={{
                                ...theme.typography.commonAvatar,
