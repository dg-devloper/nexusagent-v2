...
// icons
import { IconSettings, IconX, IconCode, IconBookmark } from '@tabler/icons-react'
        ...
        <>
            <Stack
                ...
                sx={{
                    ...
                    top: themeVariables.spacing.medium,
                    zIndex: themeVariables.zIndex.tooltip
                }}
            >
                <Box sx={{ display: 'flex', gap: themeVariables.spacing.small }}>
                    {chatflow?.id && (
                        <Button
                            ...
                            sx={{
                                ...
                                padding: `${themeVariables.spacing.small} ${themeVariables.spacing.medium}`,
                                backgroundColor: themeVariables.colors.primary.main,
                                color: 'white',
                                '&:hover': {
                                    backgroundColor: themeVariables.colors.primary.dark
                                }
                            }}
                        >
                            Integration
                    ...
                    <Button
                        ...
                        sx={{
                            minWidth: 'auto',
                            padding: themeVariables.spacing.small,
                            borderRadius: themeVariables.borderRadius.circle,
                            backgroundColor: themeVariables.colors.background.secondary,
                            color: themeVariables.colors.text.primary,
                            '&:hover': {
                                backgroundColor: themeVariables.colors.text.primary,
                                color: themeVariables.colors.background.secondary
                            }
                        }}
                    >
                        <IconSettings />
...
ModernCanvasSubHeader.propTypes = {
...
export default ModernCanvasSubHeader